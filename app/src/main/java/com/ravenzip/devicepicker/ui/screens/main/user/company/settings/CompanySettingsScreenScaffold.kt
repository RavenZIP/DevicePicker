...
import com.ravenzip.devicepicker.ui.screens.main.user.company.employees.EmployeesCompanyScreenContent
...
@Composable
fun CompanySettingsScreenScaffold(
    ...
    Scaffold(
        ...
        topBar = { TopAppBar("Настройки", backArrow = backArrow) },
    ) { innerPadding ->
        Column(
            ...
            CompanySettingsScreenContent(viewModel)
        }
    }
}
